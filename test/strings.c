...
*main - Print len
*Command to run test:
*gcc ./test/0_printf_strings.c _printf.c handle_print.c prf.c 
* get_flags.c get_width.c write_handlers.c utilts.c
*gcc ./tests/0_printf_strings.c _printf.c handle_print.c 
*prf1.c prf2.c utilts.c get_flags.c*
*/
int main( void)
{
	int len1, len2;
